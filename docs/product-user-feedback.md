...
After manually testing this game in the web browser, I found things that I liked and things that could be better.

## Things I liked

1. Visually, this game looks like a very simplified version of Rocket League. It is my favorite game, so I am glad to see the pieces coming together.
2. The code is organized fairly well.

## Things that could be improved

1. The ball behaves differently from Rocket League; it does not roll as far, and it does not bounce as much.
2. The collision between ball and car behaves differently from Rocket League. In Rocket League, hitting the ball by driving into it quickly would cause the ball to bounce into the air.
